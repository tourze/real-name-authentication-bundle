 ...
 * 银行卡三要素认证表单控制器
 */
final class PersonalAuthFormBankCardThreeController extends AbstractController
{
    #[Route(path: '/auth/personal/bank-card-three', name: 'auth_personal_bank_card_three', methods: ['GET', 'POST'])]
